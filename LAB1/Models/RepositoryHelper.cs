namespace LAB1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶清單資訊Repository Get客戶清單資訊Repository()
		{
			var repository = new 客戶清單資訊Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶清單資訊Repository Get客戶清單資訊Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶清單資訊Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
